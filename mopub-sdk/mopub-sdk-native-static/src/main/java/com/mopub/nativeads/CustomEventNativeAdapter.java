...
final class CustomEventNativeAdapter {
    ...
    static String customEventNativeClassName = "";

    public static String getCustomEventClassName() {
        return customEventNativeClassName;
    }
    ...
    public static void loadNativeAd(@NonNull final Context context,
        ...
        customEventNativeClassName = adResponse.getCustomEventClassName();
